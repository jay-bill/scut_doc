...
<body>
	<div class='login'>
	  ...
	  <div class='login_fields'>
	    <div class='login_fields__user'>
	      ...
	      <input name="login" placeholder='用户名' maxlength="16" type='text' autocomplete="off" style="width:320px;"/>
	    ...
	    <div class='login_fields__password'>
	      ...
	      <input name="pwd" placeholder='密码' maxlength="16" type='text' autocomplete="off" style="width:320px;">
	      <div class='validation'>
	        <img alt="" src='img/tick.png'>
	      </div>
	    </div>
	...
	<form id="loginForm" action="/login" method="post" style="display:none;">
		<label>账号：</label><input type="text" name="account" id="account"/><br>
